          ...
          child: Column(
            ...
            children: [
              ...
              FFButtonWidget(
                onPressed: () async {
                  _model.apiResultrc5 =
                      await WorkshopManagementAPIGroup.pOSTVehicleCall.call(
                    model: _model.textController1.text,
                    owner: _model.textController2.text,
                    year: int.tryParse(_model.textController4.text),
                    plate: _model.textController3.text,
                    maintenancesList: List.generate(
                  ...
                  if ((_model.apiResultrc5?.succeeded ?? true)) {
                    context.pushNamed('GetVehicles');
                  }
